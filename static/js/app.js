...
seagull.config(function ($translateProvider) {
  ...
  $translateProvider.translations('en-us', {
    ...
    period: '.',
    the_best_friend_of_docker: 'the best friend of docker registry',
    im_using: 'I\'m using',
    with_kernel: 'with kernel',
    and_docker: 'and Docker registry',
    ...
    docker_is_an_open_platform_for_distributed_application_for_developers_and_sysadmins: 'Docker Registry server is for hosting/delivering of docker repositories and images',
    and_seagull_provides_a_friendly_web_ui_to_monitor_docker: 'and pirate provides a friendly Web UI to monitor docker registry.',
    github: 'Github',
    go_now: 'Go now!',
	...
	seagull_is_another_open_source_tool_for_docker:'Seagull is another opensource web UI to monitor local docker',
